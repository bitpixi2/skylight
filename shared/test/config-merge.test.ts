...
import { MEL_AIRPORT } from "../src/airport.js";
...
describe("mergeConfig locationProfiles (#18)", () => {
  ...
  it("round-trips a profile carrying runway geometry (#62)", () => {
    ...
    expect(saved.locationProfiles[0].airport).toEqual(MEL_AIRPORT);
    ...
    expect(after.locationProfiles[0].airport?.runways).toEqual(MEL_AIRPORT.runways);
  });
});
